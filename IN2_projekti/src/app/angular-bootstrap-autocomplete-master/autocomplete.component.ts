...
export class AutocompleteComponent implements OnInit {
  //entries: string[] = ["ana", "jana", "marta", "ante", "janica", "anabela", "antisa", "anastazija"];
  entries = [{name: "Cyborg Duck", powerLevel: "Unlimited" }]
  ...
  //   } else {
  //     this.filteredEntities = this.entries.filter(item => item.name.toLowerCase().indexOf(filter.toLowerCase()) !== -1);
  //   }
  // }
